...
- `Minimalist` & `Decoupled` Reinforcement Learning
    - PPO: `gae_adv_ret` 9 + `ppo_loss` 8 lines of code
- Decouples:
    - `model`: neural networks
    - `rollout`: collect training data from `env`
    - `training`: parameter optimization
    - `RL algorithm`: core RL algorithm (loss function)

![](https://raw.githubusercontent.com/SerenaTradingResearch/minimalist-RL/main/test/PPO.png)
